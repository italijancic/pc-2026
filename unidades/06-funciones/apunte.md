...
**No se devuelven objetos ni JSON.** Es una restricción pedagógica y se corrige como error.

Por ahora, si necesitás devolver tres cosas, escribí tres funciones. Desde la **unidad 07** vas a
poder devolver las tres juntas en un **vector**, y ahí el llamador las recupera por índice
(`resultado[0]`, `resultado[1]`, `resultado[2]`). Esa es la forma que usa la cátedra cuando una
función tiene que entregar más de un valor — no un objeto.
