...
- No es un examen ni se entrega: es **práctica para vos**, para fijar lo que vimos en clase.
  Resolvelo por escrito igual — pensar con la lapicera en la mano no es lo mismo que leer.
- Justificá las respuestas. "Porque sí" no sirve; "porque la RAM es volátil" sí.
- El **Problema 7 sí conviene hacerlo antes de la próxima clase**: sin el entorno instalado no
  vas a poder seguir la unidad 02.
