...
<!-- Presentación de docentes y del curso.
     Mencionar: 1 clase semanal (jueves), 2 parciales. Los TP no se entregan.
...
<p class="tip">Por eso hay un <strong>TP por unidad</strong>: no se entrega, es para que detectes a tiempo lo que no quedó claro y no acumules deuda hasta el parcial.</p>
...
<p class="tip">Los <strong>TP no se entregan ni llevan nota</strong>: son práctica tuya. Pero el parcial se parece mucho a ellos, así que el que los hace llega distinto.</p>
...
<p class="lead">Su intérprete es <strong>Node.js</strong>. Por eso lo vas a instalar para la próxima clase: sin él, tu <code>.js</code> es sólo un archivo de texto.</p>
