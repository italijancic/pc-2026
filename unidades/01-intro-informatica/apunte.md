...
matrices. Por eso hay un **TP por unidad**: el objetivo es detectar a tiempo lo que no quedó
claro, no acumular deuda hasta el parcial.
...
|-----------|--------|------------|
| **TP por unidad** | Cada clase | Que puedas resolver solo lo que vimos juntos |
...
Su intérprete es **Node.js**. Por eso lo instalaste: sin él, tu archivo `.js` es sólo un
archivo de texto.
